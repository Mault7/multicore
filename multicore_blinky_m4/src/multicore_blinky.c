...
#define BLINKY_TICK_DELAY  100	/* Every 500 ms blinky will blink */
...
void GPIO_config(void){
	Chip_SCU_PinMuxSet(2, 10, SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_FUNC0);
	Chip_SCU_PinMuxSet(2, 11, SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_FUNC0);
	Chip_SCU_PinMuxSet(2, 12, SCU_MODE_PULLUP | SCU_MODE_INBUFF_EN | SCU_MODE_FUNC0);
